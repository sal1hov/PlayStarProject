...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Папка, куда будут собраны статические файлы
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'static'),  # Папка с вашими статическими файлами в разработке
]
